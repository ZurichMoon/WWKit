...
/**
 * 参考https://github.com/ElfSundae/AVDemo/blob/master/RosyWriter/Classes/RosyWriterRenderer.h
 */
@protocol MVRenderer <NSObject>
@required
...
- (BOOL)prepareForInputWithFormatDescription:(CMFormatDescriptionRef)inputFormatDescription outputRetainedBufferCountHint:(size_t)outputRetainedBufferCountHint;
- (void)reset;
...
//- (NSArray *)captureMetadataObjectTypes;
